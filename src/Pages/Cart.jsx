      ...
      <table className='w-full border border-gray-700'>
        ...
        <tbody>
          {cartArray?.map((item,index)=>(
            ...
            <td className='p-3 border border-gray-200 text-center'><button onClick={()=>dispatch(removeCartItem(item?.id))} className='bg-red-700 text-white py-3 px-4 rounded'><FontAwesomeIcon icon={faTrash} /></button></td>
          </tr>
          ))
            }
        </tbody>
...
{/* cart summary */}
    ...
    <div className="w-full pt-10 md:grid grid-cols-3 mb-10 mt-5">
      ...
      <div className='text-center'>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzibBVD9w_go7Ofo5BK44_ufJf_y7qQAoPKg&s" alt="" className='w-full h-auto'/>
        <Link to={'/'}><button className=' bg-green-600 text-white p-3 mt-5 hover:border hover:bg-white hover:border-green-600 hover:text-green-600'><FontAwesomeIcon icon={faBackward} className='me-2'/>Back Home</button></Link>
      </div>
      <div></div>
