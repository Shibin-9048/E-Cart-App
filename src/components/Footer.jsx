  ...
  return (
    <div className='py-10 md:px-20 px-10 bg-violet-900 md:grid grid-cols-[repeat(1,2fr)_repeat(2,1fr)_repeat(1,2fr)] text-white'>
        ...
        <div>
            ...
            <p className='mt-5 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt molestias odio, itaque, cupiditate eum facilis optio at reiciendis totam quibusdam iusto, ducimus velit adipisci nesciunt illo? Iure veritatis nesciunt fugit!</p>
        </div>
        ...
        <div className="flex mt-6">
          <input type="text" placeholder='E-mail id' className='p-3 rounded w-full'/>
